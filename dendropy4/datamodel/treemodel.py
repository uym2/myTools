...
import copy
import sys
from dendropy4.utility import GLOBAL_RNG
from dendropy4.utility import container
from dendropy4.utility import terminal
from dendropy4.utility import error
from dendropy4.utility import bitprocessing
from dendropy4.utility import deprecate
from dendropy4.utility import constants
from dendropy4.utility import textprocessing
from dendropy4.datamodel import basemodel
from dendropy4.datamodel import taxonmodel
from dendropy4 import dataio
...
class Tree(
    ...
    def node_distance_matrix(self):
        from dendropy4.calculate.phylogeneticdistance import NodeDistanceMatrix
    ...
    def B1(self):
        ...
        deprecate.dendropy_deprecation_warning(
                ...
                new_construct="from dendropy4.calculate import treemeasure\ntreemeasure.B1(tree)")
        from dendropy4.calculate import treemeasure
    ...
    def find_missing_splits(self, other_tree):
        ...
        deprecate.dendropy_deprecation_warning(
                ...
                new_construct="from dendropy4.calculate import treecompare\ntreecompare.find_missing_bipartitions(tree1, tree2)")
        from dendropy4.calculate import treecompare
