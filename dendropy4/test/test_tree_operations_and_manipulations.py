...
if not (sys.version_info.major >= 3 and sys.version_info.minor >= 4):
    from dendropy4.utility.filesys import pre_py34_open as open
import unittest
from dendropy4.test.support import curated_test_tree
from dendropy4.test.support import compare_and_validate
from dendropy4.test.support import pathmap
from dendropy4.test.support import dendropy4 as dendropytest
from dendropy4.utility import messaging
from dendropy4.test.support.dendropytest import ExtendedTestCase
from dendropy4.test.support.mockrandom import MockRandom
import dendropy4 as dendropy
