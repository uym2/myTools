...
from dendropy4.calculate.treecompare import TreeShapeKernel
from dendropy4.calculate.treecompare import AssemblageInducedTreeManager
from dendropy4.calculate.treecompare import AssemblageInducedTreeShapeKernel
...
class AssemblageInducedTreeManagerTestBase(unittest.TestCase):
    ...
    @staticmethod
    def get_random_tree():
        from dendropy4.model import birthdeath
