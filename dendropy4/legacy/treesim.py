...
from dendropy4.simulate import treesim
from dendropy4.simulate import popgensim
...
def pop_gen_tree(*args, **kwargs):
    deprecate.dendropy_deprecation_warning(
            ...
            new_construct="from dendropy4.simulate import popgensim\ntree = popgensim.pop_gen_tree(...)")
...
def birth_death(*args, **kwargs):
    deprecate.dendropy_deprecation_warning(
            ...
            new_construct="from dendropy4.simulate import treesim\ntree = treesim.birth_death_tree(...)")
    return treesim.birth_death_tree(*args, **kwargs)

# from dendropy4.model.birthdeath import discrete_birth_death_tree as discrete_birth_death
...
# from dendropy4.model.birthdeath import uniform_pure_birth_tree as uniform_pure_birth
...
# from dendropy4.model.coalescent import contained_coalescent_tree as contained_coalescent
...
# from dendropy4.model.coalescent import pure_kingman_tree as pure_kingman
...
# from dendropy4.model.coalescent import mean_kingman_tree as mean_kingman
...
# from dendropy4.model.coalescent import constrained_kingman_tree as constrained_kingman
...
# from dendropy4.model.treeshape import star_tree
